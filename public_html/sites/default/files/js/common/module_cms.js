    ...
    $(function(){
        var initHeader = function() {
            ...
            if(header.length > 0) {
                ...
                $('#block-sbg-main-menu-lg > ul > li', headerNav).on('mouseenter', function(){
                    if(Utility.isTb() == false ||  Utility.isTouch() == false) {
                        $('#block-sbg-main-menu-lg > ul > li', headerNav).removeClass('on');
                        $(this).addClass('on');
                        ...
                        $(this).find(headerMenu).fadeIn();
                    }
                });

                $('#block-sbg-main-menu-lg > ul > li', headerNav).on('click', function(){
        ...
        var initCookieAttention = function() {
            ...
            if(cookieAttention.length > 0) {
                ...
                setTimeout(function(){
                    ...
                    $('.agree-button', cookieAttention).on('click', function(){
            ...
            if(breadcrumb.length > 0) {
                $(window).on('resize.breadcrumb', function(){
                    if(Utility.isSp()) {
                        ...
                        $('#breadcrumb ul').width(width).css('visibility', 'visible');
                        breadcrumb.scrollLeft(width);
                    }
                    else {
                        $('#breadcrumb ul').css('width', '');
                    }
                }).trigger('resize.breadcrumb');

                $(window).on('load', function(){
                    $('#breadcrumb ul').css('width', '4000px');
                    setTimeout(function(){
