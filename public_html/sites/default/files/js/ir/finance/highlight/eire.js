/**
* EIR Javascript v1.2.2
* DATE: 2019-4-25
*/

var eirCode = '9984';
var uniCodeEir = 'yyyymmdd';
var uniCodeQir = '20200131';
...
if( (document.location.protocol == 'https:' || document.location.protocol == 'http:') && !/aspdev/.test(window.location.host)){
	...
	var qirSpecific = eirUrl + '/Custom/' + eirLevel + '/qir/' + eirCode + '/' + language + '/' + uniCodeQir +'/';
}else{
	var eirPass = '/v5parts/' + eirCode + '/' + language + '/' + uniCodeEir + '/';
	var qirSpecific = '/v5qir/' + eirCode + '/' + language + '/' + uniCodeQir + '/';
}
var eirPassCore = eirPass + 'core/';
var eirPassApp = eirPass + 'app/';
var eirPassMaterial = eirUrl + '/Custom/public/material/parts/';
var qirCommon = eirUrl + '/Custom/public/material/v5qir/';
