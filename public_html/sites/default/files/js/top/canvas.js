...
function canvasHeight() {
    var _vision = document.getElementById("block-top-philosophy-vision-strategy-html");
    var _h = _vision.offsetTop;
    if (chkDevice() == "sp") {
        _h -= 45;
    } else {
        _h -= 60;
...
function opening() {
    ...
    $({
        ...
        focalLength: opts.tmpFocalLength
    }, {
        duration: du + 1000,
        step: function () {
    ...
    $({
        ...
        backGroundSize: opts.tmpBackGroundSize
    }, {
        duration: du - 500,
        step: function () {
...
var depthStart, depthEnd, depthAdd = 50,
    depthDuration = 700;
